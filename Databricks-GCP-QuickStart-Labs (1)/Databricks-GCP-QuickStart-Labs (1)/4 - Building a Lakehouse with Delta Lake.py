...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS <your-username>.clickstream_data;
# MAGIC CREATE TABLE <your-username>.clickstream_data (
...
# MAGIC 
# MAGIC ALTER TABLE <your-username>.clickstream_data ADD CONSTRAINT dateWithinRange CHECK (event_time > '2015-01-01');
# MAGIC ALTER TABLE <your-username>.clickstream_data ADD CONSTRAINT validCountryCode CHECK (country in ('MX','TW','PE','CO','UY','PR','CL','ID','CA','GB','JP','US','PA'));
# MAGIC ALTER TABLE <your-username>.clickstream_data DROP CONSTRAINT dateWithinRange;
# MAGIC ALTER TABLE <your-username>.clickstream_data DROP CONSTRAINT validCountryCode;
